...
TARGET_SCHEMA_PID_REGULATOR_COMMON = TARGET_SCHEMA_COMMON.extend({
    ...
    vol.Required(CONF_PID_SAMPLE_PERIOD, default=DEFAULT_PID_SAMPLE_PERIOD): cv.positive_time_period,
...
class SmartThermostat(ClimateEntity, RestoreEntity, Thermostat):
    ...
    def __init__(
        ...
        if HVAC_MODE_COOL in self._hvac_list and HVAC_MODE_HEAT in self._hvac_list:
